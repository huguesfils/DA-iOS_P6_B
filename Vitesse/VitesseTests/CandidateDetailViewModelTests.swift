...
struct CandidateDetailViewModelTests {
    ...
    func testStartAndCancelEditing() async throws {
        ...
        let viewModel = await MainActor.run {
            CandidateDetailViewModel(candidate: candidate, isAdmin: false)
        }
    ...
    func testDoneEditing_success() async throws {
        ...
        let viewModel = await MainActor.run {
            CandidateDetailViewModel(candidate: original, isAdmin: true, networkService: mockService)
        }
    ...
    func testDoneEditing_failure() async throws {
        ...
        let viewModel = await MainActor.run {
            CandidateDetailViewModel(candidate: candidate, isAdmin: true, networkService: mockService)
        }
